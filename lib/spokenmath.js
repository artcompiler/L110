      ...
      */
      ...
      var Model = exports.Model = function () {
        ...
        var parse = function parse(src, env) {
          ...
          function binaryNode(op, args, flatten) {
            (0, _assert.assert)(args.length > 1, "Too few argument for binary node");
            var aa = [];
            (0, _backward.forEach)(args, function (n) {
              if (flatten && n.op === op) {
                aa = aa.concat(n.args);
          ...
          function parenExpr(tk) {
            ...
            if (e.args.length === 2 && (tk === TK_LEFTPAREN || tk === TK_LEFTBRACKET) && (tk2 === TK_RIGHTPAREN || tk2 === TK_RIGHTBRACKET)) {
          ...
          function exponentialExpr() {
            ...
            while ((t = hd()) === TK_CARET) {
              next({ oneCharToken: true });
              var _t = void 0;
              if ((isMathSymbol(args[0]) || isChemCore()) && ((_t = hd()) === TK_ADD || _t === TK_SUB)) {
                next();
                // Na^+
                args.push(unaryNode(tokenToOperator[_t], [nodeOne]));
              } else {
                var n = unaryExpr();
          ...
          function multiplicativeExpr() {
            ...
            var loopCount = 0;
            while ((t = hd()) && !isAdditive(t) && !isRelational(t) && !isImplies(t) && t !== TK_COMMA && !isEquality(t) && t !== TK_RIGHTBRACE && t !== TK_RIGHTPAREN && t !== TK_RIGHTBRACKET && t !== TK_RIGHTARROW && t !== TK_LT && t !== TK_VERTICALBAR && t !== TK_NEWROW && t !== TK_NEWCOL && t !== TK_END) {
              explicitOperator = false;
          ...
          function isPolynomialTerm(n0, n1) {
            ...
            if (!n0.lbrk && !n1.lbrk && (n0.op === Model.NUM && isVar(n1) || isVar(n0) && n1.op === Model.NUM || n0.op === Model.NUM && n1.op === Model.NUM || isVar(n0) && isVar(n1) || n0.op === Model.MUL && n0.args[n0.args.length - 1].isPolynomial && (isVar(n1) || n1.op === Model.NUM))) {
              return true;
            }
            return false;
          }
          ...
          function isImplies(t) {
            return t === TK_IMPLIES || t === TK_RIGHTARROW || t === TK_LEFTARROW || t === TK_LONGRIGHTARROW || t === TK_LONGLEFTARROW || t === TK_OVERRIGHTARROW || t === TK_OVERLEFTARROW || t === TK_LEFTRIGHTARROW || t === TK_LONGLEFTRIGHTARROW || t === TK_OVERLEFTRIGHTARROW || t === TK_VERTICALBAR;
          }
