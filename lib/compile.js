...
var _spokenmath = require("./spokenmath.js");
...
var transformer = function () {
  ...
  function composeValidation(method, options, value) {
    ...
    delete opts.dontExpandPowers;
    delete opts.dontFactorDenominators;
    delete opts.dontFactorTerms;
    delete opts.dontConvertDecimalToFraction;
    delete opts.dontSimplifyImaginary;
    delete opts.data;
    return {
  ...
  function equivSyntax(node, options, resume) {
    ...
    visit(node.elts[0], options, function (err, val) {
      ...
      visit(node.elts[1], options, function (err, val) {
        errs = errs.concat(err);
        var response = options.data && options.data.response || val.response || val;
        var score = val.score || 1;
        var methods = "equivSyntax " + (val.methods || "");
        if (response) {
          options.strict = true;
  ...
  function equivLiteral(node, options, resume) {
    ...
    visit(node.elts[0], options, function (err, val) {
      ...
      visit(node.elts[1], options, function (err, val) {
        ...
        var response = options.data && options.data.response || val.response || val;
        var score = val.score || 1;
        var methods = "equivLiteral " + (val.methods || "");
  ...
  function equivSymbolic(node, options, resume) {
    ...
    visit(node.elts[0], options, function (err, val) {
      ...
      visit(node.elts[1], options, function (err, val) {
        ...
        var response = options.data && options.data.response || val.response || val;
        var score = val.score || 1;
        var methods = "equivSymbolic " + (val.methods || "");
        if (response) {
          options.strict = true;
          options.env = {
  ...
  function equivValue(node, options, resume) {
    ...
    visit(node.elts[0], options, function (err, val) {
      ...
      visit(node.elts[1], options, function (err, val) {
        ...
        var response = options.data && options.data.response || val.response || val;
        var score = val.score || 1;
        var methods = "equivValue " + (val.methods || "");
        if (response) {
          options.strict = true;
          _mathcore2.default.evaluateVerbose({
            method: "equivValue",
  ...
  function isFactorised(node, options, resume) {
    ...
    visit(node.elts[0], options, function (err, val) {
      ...
      var response = options.data && options.data.response || val.response || val;
      var score = val.score || 1;
      var methods = "isFactorised " + (val.methods || "");
      if (response) {
        options.strict = true;
        _mathcore2.default.evaluateVerbose({
          method: "isFactorised",
  ...
  function isSimplified(node, options, resume) {
    ...
    visit(node.elts[0], options, function (err, val) {
      ...
      var response = options.data && options.data.response || val.response || val;
      var score = val.score || 1;
      var methods = "isSimplified " + (val.methods || "");
      if (response) {
        options.strict = true;
        _mathcore2.default.evaluateVerbose({
          method: "isSimplified",
  ...
  function isExpanded(node, options, resume) {
    ...
    visit(node.elts[0], options, function (err, val) {
      ...
      var response = options.data && options.data.response || val.response || val;
      var score = val.score || 1;
      var methods = "isExpanded " + (val.methods || "");
      if (response) {
        options.strict = true;
        _mathcore2.default.evaluateVerbose({
          method: "isExpanded",
  ...
  function isTrue(node, options, resume) {
    ...
    visit(node.elts[0], options, function (err, val) {
      ...
      var response = options.data && options.data.response || val.response || val;
      var score = val.score || 1;
      var methods = "isTrue " + (val.methods || "");
      if (response) {
        options.strict = true;
        _mathcore2.default.evaluateVerbose({
          method: "isTrue",
  ...
  function calculate(node, options, resume) {
    ...
    visit(node.elts[0], options, function (err, val) {
      ...
      var response = options.data && options.data.response || val.response || val;
      var score = val.score || 1;
      var methods = "calculate " + (val.methods || "");
      if (response) {
        options.strict = true;
        _mathcore2.default.evaluateVerbose({
          method: "calculate",
  ...
  function translate(dialect, val, options, resume) {
    ...
    if (source) {
      if (dialect === "ClearSpeak") {
        _spokenmath.Core.translate(options, source, function (err, val) {
          delete options.strict;
          if (err && err.length) {
            errs = errs.concat(error(err, node.elts[0]));
          }
        ...
        _latexsympy.Core.translate(options, source, function (err, val) {
          delete options.strict;
          if (err && err.length) {
            errs = errs.concat(error(err, node.elts[0]));
          }
  ...
  function format(node, options, resume) {
    ...
    visit(node.elts[0], options, function (err, val) {
      ...
      visit(node.elts[1], options, function (err, val) {
        errs = errs.concat(err);
        var response = val.response || val;
        var score = val.score || 1;
        var methods = "format " + (val.methods || "");
        if (response) {
          options.strict = true;
          _mathcore2.default.evaluateVerbose({
            method: "format",
  ...
  function isUnit(node, options, resume) {
    ...
    visit(node.elts[0], options, function (err, val) {
      ...
      visit(node.elts[1], options, function (err, val) {
        ...
        var response = options.data && options.data.response || val.response || val;
        var score = val.score || 1;
        var methods = "isUnit " + (val.methods || "");
        if (response) {
          options.strict = true;
          _mathcore2.default.evaluateVerbose({
            method: "isUnit",
...
var renderer = function () {
  ...
  function visit(node, padding) {
    ...
    if (tagName === "g" && attrs.length === 0) {
      // skip g elements without attrs
      var tag = elts;
