...
var _mathcoreLibMathcoreJs = require("./mathcore/lib/mathcore.js");

var _mathcoreLibMathcoreJs2 = _interopRequireDefault(_mathcoreLibMathcoreJs);
  ...
  function equivSyntax(node, options, resume) {
    ...
    visit(node.elts[1], options, function (err, val) {
      ...
      visit(node.elts[0], options, function (err, val) {
        ...
        if (response) {
          options.strict = true;
          _mathcoreLibMathcoreJs2["default"].evaluateVerbose({
            method: "equivSyntax",
            options: options,
            value: reference }, response, function (err, val) {
  ...
  function isFactorised(node, options, resume) {
    ...
    visit(node.elts[0], options, function (err, val) {
      ...
      if (response) {
        ...
        _mathcoreLibMathcoreJs2["default"].evaluateVerbose({
          method: "isFactorised",
          options: options }, response, function (err, val) {
          delete options.strict;
          if (err && err.length) {
            err = errs.concat(error(err, node.elts[0]));
          }
