...
define(["mathcore"], function (MathCore) {
  describe("MathCore", function() {
    describe("equivValue - decimalSeparator is set to comma", function() {
      function run(tests) {
    ...
    describe("NOT equivValue - decimalSeparator is set to comma", function() {
      function run(tests) {
        forEach(tests, function (v, i) {
          it(v[0] + " | " + v[1], function() {
            expect(MathCore.evaluate({
    ...
    describe("equivValue - defaults", function() {
      function run(tests) {
        forEach(tests, function (v, i) {
          it(v[0] + " | " + v[1], function() {
            expect(MathCore.evaluate({
    ...
    describe("NOT equivValue - defaults", function() {
      function run(tests) {
        forEach(tests, function (v, i) {
          it(v[0] + " | " + v[1], function() {
            expect(MathCore.evaluate({
