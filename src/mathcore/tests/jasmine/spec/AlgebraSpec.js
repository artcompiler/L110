...
define(["mathcore"], function (MathCore) {
  describe("Math Core", function() {
    describe("Algebra : Quadratic", function() {
      ...
      describe("hasSyntax class:polynomial, variables:['x', 'y']", function() {
        function run(tests) {
          forEach(tests, function (v, i) {
            it(v[0], function() {
              expect(MathCore.evaluate({
      ...
      describe("NOT hasSyntax class:polynomial, variables:['x', 'y']", function() {
        function run(tests) {
          forEach(tests, function (v, i) {
            it(v[0], function() {
              expect(MathCore.evaluate({
      ...
      describe("NOT hasSyntax class:number, decimalPlaces: 2", function() {
        function run(tests) {
          forEach(tests, function (v, i) {
            it(v[0], function() {
              expect(MathCore.evaluate({
      ...
      describe("hasSyntax class:number, numberFormat: integer, requireThousandsSeparator: true", function() {
        function run(tests) {
          forEach(tests, function (v, i) {
            it(v[0], function() {
              expect(MathCore.evaluate({
                ...
                options: {
                  ...
                  "requireThousandsSeparator": true,
                }
              }, v[0])).toBe(true);
            });
          });
      ...
      describe("NOT hasSyntax class:number, numberFormat: integer, requireThousandsSeparator: true", function() {
        function run(tests) {
          forEach(tests, function (v, i) {
            it(v[0], function() {
              expect(MathCore.evaluate({
      ...
      describe("hasSyntax class:number, numberFormat: decimal", function() {
        function run(tests) {
          forEach(tests, function (v, i) {
            it(v[0], function() {
              expect(MathCore.evaluate({
      ...
      describe("NOT hasSyntax class:number, numberFormat: decimal", function() {
        function run(tests) {
          forEach(tests, function (v, i) {
            it(v[0], function() {
              expect(MathCore.evaluate({
      ...
      describe("hasSyntax class: mixedFraction", function() {
        function run(tests) {
          forEach(tests, function (v, i) {
            it(v[0], function() {
              expect(MathCore.evaluate({
      ...
      describe("hasSyntax class: fraction", function() {
        function run(tests) {
          forEach(tests, function (v, i) {
            it(v[0], function() {
              expect(MathCore.evaluate({
      ...
      describe("NOT hasSyntax class: mixedFraction", function() {
        function run(tests) {
          forEach(tests, function (v, i) {
            it(v[0], function() {
              expect(MathCore.evaluate({
        ...
        run([
          ["123"],
          ["\\frac{2}{3}"],
          ["2 1/2"],  // slash means \div not \frac
        ]);
      });
      describe("hasSyntax class: binomial", function() {
        function run(tests) {
          forEach(tests, function (v, i) {
            it(v[0], function() {
              expect(MathCore.evaluate({
      ...
      describe("hasSyntax class: matrix", function() {
        function run(tests) {
          forEach(tests, function (v, i) {
            it(v[0], function() {
              expect(MathCore.evaluate({
      ...
      describe("hasSyntax class: equation", function() {
        function run(tests) {
          forEach(tests, function (v, i) {
            it(v[0], function() {
              expect(MathCore.evaluate({
      ...
      describe("NOT hasSyntax class: equation", function() {
        function run(tests) {
          forEach(tests, function (v, i) {
            it(v[0], function() {
              expect(MathCore.evaluate({
