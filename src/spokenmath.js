...
var Model = exports.Model = function () {
  ...
  function isAlphaCharCode(c) {
    return c >= 65 && c <= 90 || c >= 97 && c <= 122 || c === 39;
  }
  ...
  var parse = function parse(src, env) {
    ...
    function isRepeatingDecimal(args) {
      ...
      //   }
      // } else
      if (!args[0].lbrk && (args[0].op === Model.NUM && args[0].numberFormat === "decimal" || args[0].op === Model.VAR && args[0].args[0] === "?")) {
    ...
    function isImplies(t) {
      return t === TK_IMPLIES || t === TK_RIGHTARROW || t === TK_LEFTARROW || t === TK_LONGRIGHTARROW || t === TK_LONGLEFTARROW || t === TK_OVERRIGHTARROW || t === TK_OVERLEFTARROW || t === TK_LONGLEFTRIGHTARROW || t === TK_OVERLEFTRIGHTARROW || t === TK_VERTICALBAR;
    }
    ...
    function scanner(src) {
      ...
      function latex() {
        ...
        if (c === '$'.charCodeAt(0)) {
          ...
          _lexeme += String.fromCharCode(c);
        } else if ((0, _backward.indexOf)([' '.charCodeAt(0), ':'.charCodeAt(0), ';'.charCodeAt(0), ','.charCodeAt(0), '!'.charCodeAt(0)], c) >= 0) {
          _lexeme = "\\ ";
        } else {
