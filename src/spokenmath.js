...
(function (ast) {
  ...
  _model.Model.fn.translate = function (n1) {
    ...
    if (!n || n.op !== _model.Model.VAR) {
      n = newNode(_model.Model.VAR, ["ERROR missing rule: " + JSON.stringify(n1, null, 2)]);
    }
...
var Model = exports.Model = function () {
  ...
  var parse = function parse(src, env) {
    ...
    function isRelational(t) {
      return t === TK_LT || t === TK_LE || t === TK_GT || t === TK_GE || t === TK_IN || t === TK_TO || t === TK_PERP || t === TK_PROPTO || t === TK_NGTR || t === TK_NLESS || t === TK_NI || t === TK_NOT || t === TK_SUBSETEQ || t === TK_SUPSETEQ || t === TK_SUBSET || t === TK_SUPSET;
    }
    // Parse 'x < y'
